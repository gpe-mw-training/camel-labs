package com.redhat.gpe.training.camel.mysql;
...
public class JdbcMessageIdRepository implements IdempotentRepository<String> {
    ...
    public boolean add( String pMessageId ) {
        ...
        jdbcTemplate.update( "INSERT INTO fuse_demo.ProcessedPayments ( paymentIdentifier ) VALUES (?)", new Object[] { pMessageId } );
    ...
    public boolean contains(String key) {
        ...
        int numMatches = jdbcTemplate.queryForInt("SELECT count(0) FROM fuse_demo.ProcessedPayments where paymentIdentifier = ?", new Object[] { key });
    ...
    public boolean remove( String pMessageId ) {
        ...
        jdbcTemplate.execute( "DELETE FROM fuse_demo.ProcessedPayments WHERE paymentIdentifier = '" + pMessageId + "'" );
